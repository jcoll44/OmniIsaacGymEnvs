...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/home/jcollins/Documents/Projects/Metacognition/OmniIsaacGymEnvs/omniisaacgymenvs/psychopy/meta_vpr1.py',
...
practice_trials = data.TrialHandler(nReps=1.0, method='sequential', 
    ...
    trialList=data.importConditions('vpr_stimuli1.xlsx', selection='100:102'),
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('vpr_stimuli1.xlsx', selection='0:10'),
